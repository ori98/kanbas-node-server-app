...
const Lab5 = (app) => {
  app.get("/a5/todos/create", (req, res) => {
    console.log("Inside cfreate todo");
    const newTodo = {
      id: new Date().getTime(),
      title: "New Task",
      completed: false,
  ...
  app.get("/a5/todos", (req, res) => {
    const { completed } = req.query; // filtering todos
    ...
    // If no query parameter, return all todos
    res.json(todos);
  });
  ...
  // updating item completed status in array
  ...
  // updating item description in array
